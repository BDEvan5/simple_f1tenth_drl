...
from simple_f1tenth_drl.Planners.AgentTrainer_TrajectoryFollow import AgentTrainer_TrajectoryFollow
...
def train_endToEnd_agent():
    ...
    planner = EndToEndTest(map_name, agent_name, TestAgent)
